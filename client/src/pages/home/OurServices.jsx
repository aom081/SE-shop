...
const serviceList = [
  {
    ...
    description: "We offer a curated selection or high-quality products.",
  ...
  },
  {
    id: 4,
    title: "Gift Cards",
    description: "Give the gift of exception product with SE Shop Gift Cards.",
        ...
        <div className='md-1/2'>
          <div className=' text-left md:w-4/5'>
            ...
            <p className=' my-5 text-secondary leading-[30px]'>
              ...
              products, backd by fast shipping and exceptional Customer 
