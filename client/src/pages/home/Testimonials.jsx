        ...
        <div className='md-1/2'>
          <div className='text-left md:w-4/5'>
            ...
            <blockquote className='my-5 text-secondary leading-[30px]'>
              ...
              accessories to express my hate for coding. The Keyboard by
            ...
            <div className='flex items-center gap-4 flex-wrap'>
              <div className="avatar-group -space-x-6 rtl:space-x-reverse">
                <div className="avatar">
                  <div className="w-12">
                    <img src="images/home/testimonials/testimonials1.png" />
                  </div>
                </div>
                <div className="avatar">
                  <div className="w-12">
                ...
                <div className="avatar">
                  <div className="w-12">
                    <img src="images/home/testimonials/testimonials3.png" />
                  </div>
                </div>
              ...
              <div className='space-y-1'>
                <h5 className=' text-lg font-semibold'> Customer Feedback</h5>
                  <svg 
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-yellow-400">
